...
def main() -> None:
    # Build the demo benchmark, convert it to PyG, and train one small GraphSAGE model.
    ...
    # Evaluate only on USER nodes so the task stays aligned with the influencer labels.
    ...
    # Print a compact summary that mirrors the README story.
